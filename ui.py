...
class Ui_UiBaseWindow(object):
    def setupUi(self, UiBaseWindow):
        ...
        self.OpenFileButton = QtWidgets.QPushButton(self.InfoPanel)
        self.OpenFileButton.setGeometry(QtCore.QRect(30, 40, 100, 100))
        font = QtGui.QFont()
        ...
        self.OpenFileButton.setStyleSheet("background-color: qradialgradient(spread:reflect, cx:0.5, cy:0.5, radius:0.5, fx:0.494, fy:0.506, stop:0.0852273 rgba(255, 255, 255, 255), stop:0.892045 rgba(0, 0, 0, 227));\n"
"color: rgb(0, 0, 0);\n"
"")
        self.OpenFileButton.setObjectName("OpenFileButton")
        self.NextButton = QtWidgets.QPushButton(self.InfoPanel)
        self.NextButton.setGeometry(QtCore.QRect(150, 150, 100, 100))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.SaveButton.setGeometry(QtCore.QRect(30, 150, 100, 100))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.ClassComboBox.setGeometry(QtCore.QRect(150, 270, 91, 22))
        font = QtGui.QFont()
        ...
        self.Classlabel.setGeometry(QtCore.QRect(40, 270, 101, 21))
        font = QtGui.QFont()
        ...
        self.CloseFileButton.setGeometry(QtCore.QRect(150, 40, 100, 100))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 390, 261, 381))
        self.tabWidget.setObjectName("tabWidget")
        self.ImgTab = QtWidgets.QWidget()
        self.ImgTab.setObjectName("ImgTab")
        self.ImgInfo = QtWidgets.QTextBrowser(self.ImgTab)
        self.ImgInfo.setGeometry(QtCore.QRect(8, 10, 241, 341))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.ImgInfo.setFont(font)
        self.ImgInfo.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.ImgInfo.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.ImgInfo.setOpenLinks(True)
        ...
        self.TagInfo = QtWidgets.QTextBrowser(self.Tagtab)
        ...
        self.Sizelabel.setGeometry(QtCore.QRect(40, 310, 81, 21))
        font = QtGui.QFont()
        font.setFamily("Mongolian Baiti")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.SizeComboBox.setGeometry(QtCore.QRect(150, 310, 91, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
    ...
    def retranslateUi(self, UiBaseWindow):
        ...
        self.OpenFileButton.setText(_translate("UiBaseWindow", "Open"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.ImgTab), _translate("UiBaseWindow", "Images"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Tagtab), _translate("UiBaseWindow", "Annotations"))
